<?php
/**
 * Class to register shortcodes for callout boxes to be used in the handbooks
 * and Code Reference articles.
 *
 * @package wporg-developer
 */

class WPORG_Callout_Boxes {
...
$callouts = new WPORG_Callout_Boxes();
